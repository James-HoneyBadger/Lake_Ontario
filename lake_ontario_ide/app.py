...
def validate_script(path):
    ...
    known_prefixes = (
        ...
        "BADGER_BITE", "FACT_CHECK", "BROADCAST_CBC", "TOWN_HALL",
            "INPUT_BOX", "SET_PEN_COLOR", "SET_FILL_COLOR", "SET_CANVAS_BG",
            "FILL_RECTANGLE", "FILL_CIRCLE", "DRAW_LINE", "DRAW_RECTANGLE",
            "DRAW_CIRCLE", "DRAW_TEXT", "WAIT",
        "SUBPOENA", "RETURN_TO_OTTAWA", "GOLF_VACATION",
        "CLIMATE_EMERGENCY", "IMPEACH", "FAT_CATS_TAX",
        "DONUT_DIVIDEND", "NATIONAL_STOOGE", "GREEN_NEW_DEAL",
        "RHETORICAL_QUESTION", "LOONIE_LOOP", "SOCIAL_LICENSE",
        "ELECTORATE_PULSE", "NATIONAL_HEALTHCARE",
    )
